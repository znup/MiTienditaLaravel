...
<main class="main">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="/">BACKEND - MI Tiendita ^_^</a></li>
            </ol>
                ...
                <div class="row">
                            ...
                            <div class="card text-white bg-success">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h2"><strong>MXN {{$total->totalcompra}} (MES ACTUAL)</strong></div>
                            ...
                            <div class="card text-white bg-warning">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h2"><strong>MXN {{$total->totalventa}} (MES ACTUAL) </strong></div>
